# *********************************************************************
# FUNCTION TO INTEGRATE Y-SOLUTIONS THROUGH A SOLID LAYER (n=0)
...
from LOADGF.LN import f_solid_n0_noGrav
...
def main(Yi,int_start,int_stop,num_soln,backend,nstps,\
    ...
    # Initialize Solver
    solver = ode(f_solid_n0_noGrav.main).set_integrator(backend,atol=abs_tol,rtol=rel_tol,nsteps=nstps)
    solver.set_initial_value(Yi,int_start).set_f_params(tck_lnd,tck_mnd,tck_rnd,tck_gnd,wnd,ond,piG)
