# *********************************************************************
# FUNCTION TO PROPAGATE TRANSFORMED Y-SOLUTIONS THROUGH A SOLID LAYER (n>=1)
#
...
def main(si,Z,n,tck_lnd,tck_mnd,tck_rnd,tck_gnd,wnd,ond,piG,m,alpha):
    ...
    Aprime = np.array([[c11, c12, c13, c14, c15, c16], \
    ...
    Zc5 = ((alpha+2.)/si)*Z[4]
    Zc6 = ((alpha+1.)/si)*Z[5]
    Zc  = np.array([Zc1,Zc2,Zc3,Zc4,Zc5,Zc6])
