# *********************************************************************
# FUNCTION TO INTEGRATE Y-SOLUTIONS THROUGH FLUID LAYER (n=0)
#
...
from LOADGF.LN import f_fluid_n0
...
def main(Yi,int_start,int_stop,num_soln,backend,nstps,\
    ...
    # Initialize Solver
    solver = ode(f_fluid_n0.main).set_integrator(backend,atol=abs_tol,rtol=rel_tol,nsteps=nstps)
    solver.set_initial_value(Yi,int_start).set_f_params(tck_lnd,tck_rnd,tck_gnd,wnd,ond,piG)
