...
#  :: Compute Love Numbers Analytically for a Homogeneous Sphere
#
...
# Note: Use existing file with radial layers (homogeneous)
#       for consistency with existing LoadDef programs
...
# Output filename
file_ext = ("analytical_Homogeneous_Vp05.92_Vs03.42_Rho03.00" + suffix + ".txt") 
