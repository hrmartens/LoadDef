...
# *********************************************************************
# Convolve polar disk loads with the LGFs 
#
...
loadfile_prefix = ("convgf_custom_symcaps")
...
# Provide a common geographic mesh? 
...
common_mesh = False
# # NOTE: It can take a long time to interpolate the load onto a high-resolution mesh. 
# #       Upwards of an hour or more for very high resolution meshes on a laptop computer.
# #       But, this is only done once, and then all stations use the same mesh. 
...
#convmesh = ("../output/Grid_Files/nc/commonMesh/commonMesh_disk_0.5_0.5_60.0_90.0_0.1_0.5_70.0_90.0_0.01_0.5_75.0_90.0_0.005_0.5_79.0_90.0_0.001_0.5.nc")
#mesh_params = ("0.5_0.5_60.0_90.0_0.1_0.5_70.0_90.0_0.01_0.5_75.0_90.0_0.005_0.5_79.0_90.0_0.001_0.5")
#convmesh = ("../output/Grid_Files/nc/commonMesh/commonMesh_polarDisks_0.001-11.0_0.005-15.0_0.01-20.0_0.1-30.0_0.5-150.0_0.1-160.0_0.01-165.0_0.005-169.0_0.001.nc")
#mesh_params = ("0.001-11.0_0.005-15.0_0.01-20.0_0.1-30.0_0.5-150.0_0.1-160.0_0.01-165.0_0.005-169.0_0.001")

# Planet Radius (in meters; used for Greens function normalization when common_mesh is True)
...
# Optional: Additional string to include in output filenames
if common_mesh:
    mtag = ("_commonMesh_" + mesh_params)
else:
    mtag = ("_stationMesh_z111_z215_z320_z430_azm0p5")
outstr = ("_" + pmod + mtag)
...
if (rank == 0):
    ...
    if isinstance(slat,float): # only 1 station
        numel = 1
    else:
        numel = len(slat)
...
if (rank == 0):
    if common_mesh: 
        ...
        for hh in range(0,len(load_files)):
            ...
            print(':: Number of Grid Points: %s | Size of Load Grid: %s' %(str(len(ilat)), str(len(llat))))
