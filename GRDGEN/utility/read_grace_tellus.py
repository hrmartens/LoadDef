...
def main(filename,current_date,ldfl2=None,ldfl3=None,scl=None,avsolns=False,appscaling=False): 
    ...
    lwe_info = f.variables['lwe_thickness'] 
    ...
    # Convert Times (in Days Since 2001-01-01 00:00:00.0) to Python Datetimes
    ...
    for ii in range(0,len(time)):
        ...
        #year_month.append(datetime.datetime(my_dates[ii].year,my_dates[ii].month,1,0,0,0))
