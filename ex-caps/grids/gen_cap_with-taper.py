...
# *********************************************************************
# Create spherical cap loads at each pole with linear tapers
#
...
# If load is linearly tapered, a gspace that's lower-resolution than the convolution/common mesh is okay;
#   load will be interpolated linearly onto the convolution/common mesh
gspace = 0.01 
  
# Output Filename
outfile = ("custom_symcaps_10deg_linear-taper-5")
